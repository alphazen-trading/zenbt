...
class BacktestOld:
    ...
    def backtest_signals(
        self, long_entries, long_exits, short_entries, short_exits
    ): ...
    def backtest(self): ...
    @staticmethod
...
class Strategy:
    ...
    def create_market_order(
        self, index, client_order_id, side, size, sl=None, tp=None
    ): ...
    def create_limit_order(
        self, index, client_order_id, side, size, price, sl=None, tp=None
    ): ...
